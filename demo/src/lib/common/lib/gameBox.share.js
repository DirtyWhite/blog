    ...
    var extraAction = function (config, id, type) {
        ...
        if (config.extra && config.extra.custom && config.extra.custom.activityUri) {
            ...
            if (/\?/.test(config.shareUrl)) {
                ...
                config.shareUrl = config.shareUrl + "&ext=" + config.extra.custom.activityUri;
            } else {
                config.shareUrl = config.shareUrl + "?ext=" + config.extra.custom.activityUri;
            }
            ...
            if (type == "hasget") {
                ...
                config.extra.customUrl = config.extra.customUrl + "&ext=" + config.extra.custom.activityUri;
            } else if (type == "noget") {
            ...
            function _openShare() {
                if (_this.opts.isGetData) {
                    if (_this.getData) {
                        ...
                        window.setShareData = function (e) { //alert(1);
                            _this.getData = e;
