(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var hex = __assign$1({}, rgba, {
        test: isFirstChars('#'), parse: function (v) {
            var r = '';
            var g = '';
            var b = '';
            if (v.length > 4) {
        ...
        for (var key in tracks) {
            if (tracks.hasOwnProperty(key)) {
                ...
                trackKeyframes[key] = keyframes(__assign({}, keyframeProps, {
                    duration: duration || calculatedDuration, ease: ease,
                    elapsed: elapsed,
                    loop: loop,
                    yoyo: yoyo,
                    flip: flip
    ...
    ***************************************************************************** */
    ...
    var contains$1 = function (term) {
        return function (v) {
            return typeof v === 'string' && v.indexOf(term) !== -1;
        };
    };
    var isFirstChars$1 = function (term) {
        return function (v) {
            return typeof v === 'string' && v.indexOf(term) === 0;
        };
    };
    ...
    var hex$1 = __assign$2({}, rgba$1, {
        test: isFirstChars$1('#'), parse: function (v) {
            var r = '';
            var g = '';
            var b = '';
            if (v.length > 4) {
