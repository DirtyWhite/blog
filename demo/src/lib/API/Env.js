class Env {
    constructor() {
        ...
        this.isWexin = this.ua.toLocaleLowerCase().match(/MicroMessenger/i) == "micromessenger";
        ...
        this.isLocal = this.href.indexOf('localhost') > -1 || this.href.indexOf('192.168') > -1;
        this.isTuer = /BunnyEarsStory/gi.test(this.ua);
        this.isAndroidTuer = this.isAndroid && this.isTuer;
        this.isIosTuer = this.isIos && this.isTuer;
    }
}
let env = new Env();
export default env;